// Filename: ChallengesAggregatorAppSettings.cs
...
namespace eDoxa.Challenges.Aggregator.Infrastructure
{
    public class ChallengesAggregatorAppSettings : IHasApiResourceAppSettings<EndpointsOptions>
    {
        [Required]
