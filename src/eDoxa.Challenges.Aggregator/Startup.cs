...
using eDoxa.Challenges.Aggregator.Infrastructure;
...
namespace eDoxa.Challenges.Aggregator
{
    public sealed class Startup
    {
        private const string AzureServiceBusDiscriminator = "challenges.aggregator";
        ...
        public Startup(IConfiguration configuration, IHostingEnvironment hostingEnvironment)
        {
            ...
            AppSettings = configuration.GetAppSettings<ChallengesAggregatorAppSettings>(ChallengesAggregator);
        }

        private ChallengesAggregatorAppSettings AppSettings { get; }
        ...
        {
            services.AddAppSettings<ChallengesAggregatorAppSettings>(Configuration);
