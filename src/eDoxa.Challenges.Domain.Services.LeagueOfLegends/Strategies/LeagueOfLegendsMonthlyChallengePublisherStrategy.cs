...
namespace eDoxa.Challenges.Domain.Services.LeagueOfLegends.Strategies
{
    public sealed class LeagueOfLegendsMonthlyChallengePublisherStrategy : IChallengePublisherStrategy
    {
        public IEnumerable<Challenge> Challenges
        {
            get
            {
                yield return new LeagueOfLegendsChallenge("Monthly 1", ChallengePublisherPeriodicity.Monthly);
                yield return new LeagueOfLegendsChallenge("Monthly 2", ChallengePublisherPeriodicity.Monthly);
                yield return new LeagueOfLegendsChallenge("Monthly 3", ChallengePublisherPeriodicity.Monthly);
            }
        }
    }
}