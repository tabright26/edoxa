import { LOAD_LEAGUEOFLEGENDS_SUMMONERS_BY_NAME_SUCCESS, LOAD_LEAGUEOFLEGENDS_SUMMONERS_BY_NAME_FAIL, LeagueOfLegendsActionTypes } from "store/arena/games/leagueOfLegends/types";
