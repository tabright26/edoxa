...
import { LOAD_WITHDRAWAL_TOKEN_AMOUNTS_SUCCESS, LOAD_WITHDRAWAL_TOKEN_AMOUNTS_FAIL, WITHDRAWAL_TOKEN_SUCCESS, WITHDRAWAL_TOKEN_FAIL, WithdrawalState, WithdrawalActionTypes } from "./types";
...
export const reducer = (state = initialState, action: WithdrawalActionTypes): WithdrawalState => {
  switch (action.type) {
    case LOAD_WITHDRAWAL_TOKEN_AMOUNTS_SUCCESS: {
    ...
    case LOAD_WITHDRAWAL_TOKEN_AMOUNTS_FAIL:
    default: {
      return state;
    }
  }
