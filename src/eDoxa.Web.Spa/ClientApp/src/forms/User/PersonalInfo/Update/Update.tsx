...
const UpdatePersonalInfoForm: FunctionComponent<any> = ({ handleSubmit, handleCancel, initialValues: { lastName, birthDate, gender } }) => (
...
export default reduxForm<any, { handleCancel: () => any }, string>({ form: UPDATE_PERSONALINFO_FORM, validate })(UpdatePersonalInfoForm);
