...
const CreatePersonalInfoForm: FunctionComponent<any> = ({ handleSubmit }) => (
...
export default reduxForm<any, { handleCancel: () => any }, string>({ form: CREATE_PERSONALINFO_FORM, validate })(CreatePersonalInfoForm);
