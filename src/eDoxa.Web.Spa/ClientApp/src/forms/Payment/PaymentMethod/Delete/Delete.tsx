...
const DeletePaymentMethodForm: FunctionComponent<any> = ({ handleSubmit, handleCancel }) => (
...
export default reduxForm<any, { handleCancel: () => {} }, string>({ form: DELETE_PAYMENTMETHOD_FORM })(DeletePaymentMethodForm);
