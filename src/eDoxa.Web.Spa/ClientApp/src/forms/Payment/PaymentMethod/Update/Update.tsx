...
const UpdatePaymentMethodForm: FunctionComponent<any> = ({
  handleSubmit,
  initialValues: {
...
export default reduxForm<any, {}, string>({ form: UPDATE_PAYMENTMETHOD_FORM, validate })(UpdatePaymentMethodForm);
