...
const UpdateBankAccountForm: FunctionComponent<any> = ({ handleSubmit, handleCancel }) => (
...
export default reduxForm<any, { handleCancel: () => {} }, string>({ form: UPDATE_BANK_ACCOUNT_FORM })(UpdateBankAccountForm);
