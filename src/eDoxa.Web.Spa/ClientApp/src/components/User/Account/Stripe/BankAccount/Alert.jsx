...
import withUserAccountStripeBankAccountContainer from './Container';

const UserAccountStripeBankAccountAlert = ({ hasBankAccount }) => {
  if (hasBankAccount) {
    return (
      <Alert variant="success" className="mt-4 mb-0">
        ...
        <div className="d-flex">
          <p className="mb-0">
            ...
            information. The funds will then be transferred directly to your
            account from eDoxa.
          </p>
