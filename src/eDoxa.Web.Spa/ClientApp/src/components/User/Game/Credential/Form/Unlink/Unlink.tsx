...
const UnlinkGameCredentialForm: FunctionComponent<any> = ({ unlinkGameCredential, handleSubmit, handleCancel, error }) => (
  <Form
...
const enhance = compose<any, any>(reduxForm<any, { handleCancel: () => {} }, string>({ form: UNLINK_GAME_CREDENTIAL_FORM }));
