...
import { doxatagRegex, DOXATAG_REQUIRED, DOXATAG_INVALID } from "validation";
...
const validate = values => {
  ...
  } else if (!doxatagRegex.test(values.name)) {
...
export default connect(mapStateToProps)(enhance(UpdateUserDoxatagForm));
