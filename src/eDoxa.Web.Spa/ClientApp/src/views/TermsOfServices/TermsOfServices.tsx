      ...
      <CardBody className="text-justify p-5">
        ...
        <section>
          ...
          <article>
            <h3>CONSIDERATION</h3>
            <p>
              You agree to these Terms of Use by accessing or using the Website, registering for Services offered on the Website, or by accepting, uploading, submitting or downloading any information
              or content from or to the Website. IF YOU DO NOT AGREE TO BE BOUND BY ALL OF THESE TERMS OF USE, DO NOT USE THE WEBSITE. These Terms of Use constitute a legal agreement between you and
              eDoxa and shall apply to your use of the Website and the Services even after termination.
            </p>
          </article>
          <article>
            <h3>ELIGIBILITY</h3>
            ...
            <ul>
              ...
              <li>
                ...
                reserves the right to confirm that such permission has been granted and to close or restrict any Accounts until eDoxa is satisfied that a parent or legal guardian has read the T&amp;Cs
                and agrees to allow their minor child to hold an account.
              </li>
              <li>
                Certain sections of the Site are age gated to prevent minors from accessing games such as pay-to-enter challenges and tournaments unless permission has been given from parent or legal
                guardian. Minors may be prohibited from entering tournaments or challenges based on ESRB or other game ratings, or conditions set by eDoxa.
              </li>
              <li>
              ...
              <li>
                You may establish only one account per person to participate in the Services offered on the Website. In the event eDoxa discovers that you have opened more than one account per person,
                in addition to any other rights that eDoxa may have, eDoxa reserves the right to suspend or terminate any or all of your accounts and terminate, withhold or revoke the awarding of any
                prizes. You are responsible for maintaining the confidentiality of your login names and passwords and you accept responsibility for all activities, charges, and damages that occur
                under your account. It shall be a violation of these Terms of Use to allow any other person to use your account to participate in any contest. If you have reason to believe that
                someone is using your account without your permission, you should contact us immediately at help@edoxa.gg. We will not be responsible for any loss or damage resulting from your failure
                to notify us of unauthorized use. If we request registration information from you, you must provide us with accurate and complete information and must update the information when it
                changes.
              </li>
              <li>
          ...
          <article>
            ...
            <p>
              ...
              disqualify any entrant from a Contest, refuse to award benefits or prizes and require the return of any prizes, if the entrant engages in conduct the Company deems to be improper, unfair
              or otherwise adverse to the operation of the Contest or is in any way detrimental to other entrants. Improper conduct includes, but is not limited to:
            </p>
            <ul>
            ...
            <p>
              ...
              Parties”), from any and all liability, claims or actions of any kind whatsoever, including but not limited to injuries, damages, or losses to persons and property which may be sustained
              in connection with participation in the Contest, the receipt, ownership, use or misuse of any prize or while preparing for, participating in and/or travelling to or from any prize
              related activity, as well as any claims based on publicity rights, defamation, or invasion of privacy. eDoxa may, in its sole and absolute discretion, require an Authorized Account
              Holder to execute a separate release of claims similar to the one listed above in this Paragraph as a condition of being awarded any prize or receiving any payout.
            </p>
            <p>
              ...
              utility or telephone outages; omissions, interruptions, deletions or defects of any telephone system or network, computer online systems, data, computer equipment, servers, providers, or
              software (including, but not limited to software and operating systems that do not permit an entrant to participate in a Contest), including without limitation any injury or damage to
              any entrant’s or any other person’s computer or video equipment relating to or resulting from participation in a Contest; inability to access the Website, or any web pages that are part
              of or related to the Website; theft, tampering, destruction, or unauthorized access to, or alteration of, entries and/or images of any kind; data that is processed late or incorrectly or
              is incomplete or lost due to telephone, postal issues, computer or electronic malfunction or traffic congestion on telephone lines or transmission systems, or the Internet, or any
              service provider’s facilities, or any phone site or website or for any other reason whatsoever; typographical, printing or other errors, or any combination thereof.
            </p>
            <p>
              eDoxa is not responsible for incomplete, illegible, misdirected or stolen entries. If for any reason a Contest is not capable of running as originally planned, or if a Contest, computer
              application, or website associated therewith (or any portion thereof) becomes corrupted or does not allow the proper entry to a Contest in accordance with the Terms of Use or applicable
              Contest rules, or if infection by a computer (or similar) virus, bug, tampering, unauthorized intervention, actions by entrants, fraud, technical failures, or any other causes of any
              kind, in the sole opinion of eDoxa corrupts or affects the administration, security, fairness, integrity, or proper conduct of a Contest, the Company reserves the right, at its sole
              discretion, to disqualify any individual implicated in such action and/or to cancel, terminate, extend, modify or suspend the Contest, and select the winner(s) from all eligible entries
              received. If such cancellation, termination, modification or suspension occurs, notification will be posted on the Website.
            </p>
            <p>
              ANY ATTEMPT BY AN ENTRANT OR ANY OTHER INDIVIDUAL TO DELIBERATELY DAMAGE THE WEBSITE OR UNDERMINE THE LEGITIMATE OPERATION OF ANY CONTEST IS A VIOLATION OF CRIMINAL AND/OR CIVIL LAWS AND
              SHOULD SUCH AN ATTEMPT BE MADE, EDOXA RESERVES THE RIGHT TO SEEK DAMAGES AND OTHER REMEDIES FROM ANY SUCH PERSON TO THE FULLEST EXTENT PERMITTED BY LAW.
            </p>
            ...
            <p>
              ...
              Account Holder, eDoxa will, in its sole and absolute discretion, utilize certain information collected by eDoxa to assist in verifying the identity and/or eligibility of such Authorized
              Account Holder.
            </p>
            <p>
          ...
          <article>
            ...
            <p>
              Guaranteed prizes are offered in connection with some of the Contests offered by the Website. Each Contest or promotion is governed by its own set of official rules. We encourage you to
              read such Contest and promotions Rules before participating.
            </p>
          </article>
          <article>
            ...
            <p>
              ...
              applicable documentation associated with the Contest. From all entries received for each Contest, winners are determined by the individuals who use their skill and knowledge of relevant
              sports information and fantasy sports rules to accumulate the most points according to the corresponding scoring rules. The Website and Contests may not be used for any form of illicit
              gambling.
            </p>
          </article>
          <article>
          ...
          <article>
            <h3>PRIZES</h3>
            <p>
              At the conclusion of each Contest, prizes will be immediately awarded except in circumstances where technical failure or other reasons prevent such timely payout. Prizes won are added to
              the winning participants account balance. In the event of a tie, prizes are divided evenly amongst the participants that have tied.
            </p>
            <p>
              eDoxa reserves the right, in its sole discretion, to cancel or suspend the contests (or any portion thereof) should virus, bugs, unauthorized human intervention, or other causes corrupt
              administration, security, fairness, integrity or proper operation of the contest (or any portion thereof) warrant doing so. Notification of such changes may be provided by eDoxa to its
              customers but will not be required.
            </p>
          </article>
          <article>
            <h3>INACTIVITY POLICY</h3>
            <p>
              For any account that has been dormant, eDoxa reserves the right to assess a maintenance fee of $2.00 per month from the remaining balance on deposit. A dormant account is any account in
              which the member has not logged on to the Site in three consecutive months. The inactivity fee will commence on the day after becoming dormant until the player&#39;s balance is depleted
              to zero.
            </p>
          </article>
          <article>
            ...
            <p>
              Entrants may withdraw their cash prize awards as well as cash deposits by using the “Withdrawal” option on the Website. Entrants may be requested to complete an affidavit of eligibility
              and a liability/publicity release (unless prohibited by law) and/or appropriate tax forms and forms of identification including but not limited to a Driver’s License, Proof of Residence,
              and/or any information relating to payment/deposit accounts as reasonably requested by eDoxa in order to complete the withdrawal of prizes. Failure to comply with this requirement may
              result in disqualification and forfeiture of any prizes. Disqualification or forfeiture of any prizes may also occur if it is determined any such entrant did not comply with these Terms
              of Use in any manner.
            </p>
            ...
            <ul>
              ...
              <li>
                You may withdraw into the same PayPal account that you used to deposit money with. If you did not deposit money with a PayPal account or want to withdraw to a different account then we
                may have to perform additional checks.
              </li>
            ...
            <p>
              We conduct anti-fraud checks on wagering patterns and deposits of users prior to processing all withdrawals. We may request additional information before your withdrawal is approved. We
              reserve the right to refuse any withdrawal request that doesn’t meet the guidelines of our Terms of Use.
            </p>
            <p>
            ...
            <p>
              No substitution or transfer of prize is permitted, except that eDoxa reserves the right to substitute a prize of equal value or greater if the advertised prize is unavailable. All prizes
              are awarded “as is” and without warranty of any kind, express or implied (including, without limitation, any implied warranty of merchantability for a particular purpose).
            </p>
            ...
            <p>
              eDoxa will only release withdrawals to a different credit card or other payment method other than that which was used to make deposit(s) after the aggregate amount of such deposit(s) has
              already been released back to the credit card(s) or payment method(s) used for the deposit(s).
            </p>
          </article>
          <article>
          ...
          <article>
            ...
            <p>
              ...
              expressed herein, eDoxa hereby reserves the right to suspend or terminate any member’s account, to block Site access, disqualify them from any tournament, void winnings, and in the event
              illegal activity is discovered, to disclose member information to law enforcement, and/or to commence legal action at the sole and exclusive discretion of eDoxa.
            </p>
          </article>
          <article>
          ...
          <article>
            ...
            <ul>
              ...
              <li>
                Account Suspension: Upon the receipt of a credible and validated complaint, eDoxa may also elect to immediately suspend the membership of the member implicated in the abuse. Suspension
                serves as a &quot;Final&quot; warning and will prevent the member from continuing their abusive &quot;Spamming&quot; behavior. eDoxa will evaluate each validated abuse incident on a
                case-by-case basis and impose Termination or Suspension at its sole discretion, and may void any associated winnings. The Site reserves the right to lift the suspension of a member at
                any time, at its sole discretion.
              </li>
              <li>
                Account Termination: Upon the receipt of a credible and validated complaint, the Site may immediately terminate the membership of the individual member implicated in the abuse and may
                void any associated winnings.
              </li>
            </ul>
          </article>
          <article>
          ...
          <article>
            ...
            <p>
              THE WEBSITE, INCLUDING, WITHOUT LIMITATION, ALL CONTENT, SOFTWARE, AND FUNCTIONS MADE AVAILABLE ON OR ACCESSED THROUGH OR SENT FROM THE WEBSITE, ARE PROVIDED “AS IS,” “AS AVAILABLE,” AND
              “WITH ALL FAULTS.” TO THE FULLEST EXTENT PERMISSIBLE BY LAW, THE COMPANY AND ITS PARENTS, SUBSIDIARIES AND AFFILIATES MAKE NO REPRESENTATION OR WARRANTIES OR ENDORSEMENTS OF ANY KIND
              WHATSOEVER (EXPRESS OR IMPLIED) ABOUT: (A) THE WEBSITE; (B) THE CONTENT AND SOFTWARE ON AND PROVIDED THROUGH THE WEBSITE; (C) THE FUNCTIONS MADE ACCESSIBLE ON OR ACCESSED THROUGH THE
              WEBSITE; (D) THE MESSAGES AND INFORMATION SENT FROM THE WEBSITE BY USERS; (E) ANY PRODUCTS OR SERVICES OFFERED VIA THE WEBSITE OR HYPERTEXT LINKS TO THIRD PARTIES; AND/OR (F) SECURITY
              ASSOCIATED WITH THE TRANSMISSION OF SENSITIVE INFORMATION THROUGH THE WEBSITE OR ANY LINKED SITE. THE COMPANY DOES NOT WARRANT THAT THE WEBSITE, ANY OF THE WEBSITES’ FUNCTIONS OR ANY
              CONTENT CONTAINED THEREIN WILL BE UNINTERRUPTED OR ERROR-FREE; THAT DEFECTS WILL BE CORRECTED; OR THAT THE WEBSITES OR THE SERVERS THAT MAKES THEM AVAILABLE ARE FREE OF VIRUSES OR OTHER
              HARMFUL COMPONENTS.
            </p>
            <p>
          ...
          <article>
            ...
            <p>
              ...
              SUBSIDIARIES, OR AFFILIATES, OR THE DIRECTORS, OFFICERS, EMPLOYEES, OR OTHER REPRESENTATIVES OF EACH OF THEM (COLLECTIVELY, THE “COMPANY ENTITIES AND INDIVIDUALS”), BE LIABLE TO YOU FOR
              ANY LOSS OR DAMAGES OF ANY KIND (INCLUDING, WITHOUT LIMITATION, FOR ANY SPECIAL, DIRECT, INDIRECT, INCIDENTAL, EXEMPLARY, ECONOMIC, PUNITIVE, OR CONSEQUENTIAL DAMAGES) THAT ARE DIRECTLY
              OR INDIRECTLY RELATED TO (1) THE WEBSITE, THE CONTENT, OR YOUR UPLOAD INFORMATION; (2) THE USE OF, INABILITY TO USE, OR PERFORMANCE OF THE WEBSITE; (3) ANY ACTION TAKEN IN CONNECTION
              WITH AN INVESTIGATION BY THE COMPANY OR LAW ENFORCEMENT AUTHORITIES REGARDING YOUR USE OF THE WEBSITE OR CONTENT;(4) ANY ACTION TAKEN IN CONNECTION WITH COPYRIGHT OWNERS; OR (5) ANY
              ERRORS OR OMISSIONS IN THE WEBSITE’S TECHNICAL OPERATION, EVEN IF FORESEEABLE OR EVEN IF THE COMPANY ENTITIES AND INDIVIDUALS HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES WHETHER
              IN AN ACTION OF CONTRACT, NEGLIGENCE, STRICT LIABILITY TORT (INCLUDING, WITHOUT LIMITATION, WHETHER CAUSED IN WHOLE OR IN PART BY NEGLIGENCE, ACTS OF GOD, TELECOMMUNICATIONS FAILURE, OR
              THEFT OR DESTRUCTION OF THE WEBSITE). IN NO EVENT WILL THE COMPANY ENTITIES AND INDIVIDUALS BE LIABLE TO YOU OR ANYONE ELSE FOR LOSS OR INJURY, INCLUDING, WITHOUT LIMITATION, DEATH OR
              PERSONAL INJURY. SOME STATES DO NOT ALLOW THE EXCLUSION OR LIMITATION OF INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO THE ABOVE LIMITATION OR EXCLUSION MAY NOT APPLY TO YOU. IN NO EVENT SHALL
              THE COMPANY ENTITIES AND INDIVIDUALS TOTAL LIABILITY TO YOU FOR ALL DAMAGES, LOSSES, OR CAUSES OF ACTION EXCEED ONE HUNDRED DOLLARS ($100). THE COMPANY ENTITIES AND INDIVIDUALS ARE NOT
              RESPONSIBLE FOR ANY DAMAGE TO ANY USER’S COMPUTER, HARDWARE, COMPUTER SOFTWARE, OR OTHER EQUIPMENT OR TECHNOLOGY INCLUDING, WITHOUT LIMITATION, DAMAGE FROM ANY SECURITY BREACH OR FROM
              ANY VIRUS, BUGS, TAMPERING, FRAUD, ERROR, OMISSION, INTERRUPTION, DEFECT, DELAY IN OPERATION OR TRANSMISSION, COMPUTER LINE OR NETWORK FAILURE OR ANY OTHER TECHNICAL OR OTHER
              MALFUNCTION. YOUR ACCESS TO AND USE OF THIS WEBSITE IS AT YOUR RISK. IF YOU ARE DISSATISFIED WITH THE WEBSITE OR ANY OF THE CONTENT, YOUR SOLE AND EXCLUSIVE REMEDY IS TO DISCONTINUE
              ACCESSING AND USING THE WEBSITE OR THE CONTENT. YOU RECOGNIZE AND CONFIRM THAT IN THE EVENT YOU INCUR ANY DAMAGES, LOSSES OR INJURIES THAT ARISE OUT OF THE COMPANY’S ACTS OR OMISSIONS,
              THE DAMAGES, IF ANY, CAUSED TO YOU ARE NOT IRREPARABLE OR SUFFICIENT TO ENTITLE YOU TO AN INJUNCTION PREVENTING ANY EXPLOITATION OF ANY WEBSITE OR OTHER PROPERTY OWNED OR CONTROLLED BY
              THE COMPANY AND/OR ITS PARENTS, SUBSIDIARIES, AND/OR AFFILIATES OR YOUR UPLOAD INFORMATION, AND YOU WILL HAVE NO RIGHTS TO ENJOIN OR RESTRAIN THE DEVELOPMENT, PRODUCTION, DISTRIBUTION,
              ADVERTISING, EXHIBITION OR EXPLOITATION OF ANY COMPANY WEBSITE OR OTHER PROPERTY OR YOUR UPLOAD INFORMATION OR ANY AND ALL ACTIVITIES OR ACTIONS RELATED THERETO. BY ACCESSING THE
              WEBSITE, YOU UNDERSTAND THAT YOU MAY BE WAIVING RIGHTS WITH RESPECT TO CLAIMS THAT ARE AT THIS TIME UNKNOWN OR UNSUSPECTED. ACCORDINGLY, YOU AGREE TO WAIVE THE BENEFIT OF ANY LAW,
              INCLUDING, TO THE EXTENT APPLICABLE, CALIFORNIA CIVIL CODE SECTION 1542, THAT OTHERWISE MIGHT LIMIT YOUR WAIVER OF SUCH CLAIMS.
            </p>
          </article>
          <article>
            ...
            <p>
              ...
              States and foreign laws and international conventions. Content on the Website is provided to you AS IS for your information and personal use only and may not be used, copied, reproduced,
              distributed, transmitted, broadcast, displayed, sold, licensed, or otherwise exploited for any other purposes whatsoever without the prior written consent of the respective owners. eDoxa
              reserves all rights not expressly granted in and to the Website and the Intellectual Property. You agree to not engage in the use, copying, or distribution of any of the Intellectual
              Property other than expressly permitted herein. If you download or print a copy of the Intellectual Property for personal use, you must retain all copyright and other proprietary notices
              contained therein. You agree not to circumvent, disable or otherwise interfere with security related features of the Website or features that prevent or restrict use or copying of any
            ...
            <p>
              ...
              unlawful, or otherwise objectionable (hereinafter, “Prohibited Content”). Posting of any Prohibited Content, in addition to any and all other rights and remedies available to eDoxa, may
            ...
            <p>
              ...
              period of time required for the deletion to take full effect. However, the User Submission may still exist in our backup copies, which are not publicly available. If your User Submission
              is shared with third parties, those third parties may have retained copies of your User Submissions. In addition, if we made use of your User Submission before you deleted it, we will
              continue to have the right to make, duplicate, redistribute, and sublicense those pre-existing uses, even after you delete the User Submission. Terminating your account on a Service will
              not automatically delete your User Submissions.
            </p>
            <p>
              We may refuse or remove a User Submission without notice to you. However, we have no obligation to monitor User Submissions, and you agree that neither we nor our parents, subsidiaries,
              affiliates, employees, or agents will be liable for User Submissions or any loss or damage resulting from User Submissions.
            </p>
            <p>
              Except as provided in the Privacy Policy, we do not guarantee that User Submissions will be private, even if the User Submission is in a password- protected area. Accordingly, you should
          ...
          <article>
            ...
            <p>
              ...
              disputes arising out of or relating to the Services. Notwithstanding any other provisions of these T&amp;Cs, we may seek injunctive or other equitable relief from any court of competent
              jurisdiction. You agree that any dispute that cannot be resolved between the parties shall be resolved individually, without resort to any form of class action.
            </p>
            <p>
              ...
              activities, you certify that you meet the age and other eligibility requirements for the Site and the Services set forth in the T&amp;Cs. If you do not meet the age and other eligibility
              requirements, please discontinue using the Site and the Services immediately.
            </p>
          </article>
        </section>
      </CardBody>
