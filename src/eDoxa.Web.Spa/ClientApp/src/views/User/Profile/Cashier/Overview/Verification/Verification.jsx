...
import StripeBankAccountForm from "forms/Stripe/Account";
...
//   );
// };
let StripeBankAccountElements = ({ actions, stripe }) => <StripeBankAccountForm.Verify onSubmit={fields => actions.changeBankAccount(fields, stripe).then(() => {})} handleCancel={() => {}} />;

StripeBankAccountElements = injectStripe(StripeBankAccountElements);

const Verification = ({ bankAccounts: { data, isLoading, error }, hasBankAccount, actions }) => (
...
export default connectStripeBankAccounts(Verification);
