import React, { Suspense, useState, FunctionComponent, useEffect } from "react";
import {
  Container,
  Card,
  Button,
...
import AccountModal from "components/Service/Identity/Account/Modal";
import { isRegisterVisited } from "utils/cookies/constants";
...
type OwnProps = { cookies: Cookies };

type DispatchProps = { showRegisterAccountModal: () => void };

type InnerProps = DispatchProps & { cookies: Cookies };

type OutterProps = {};

type Props = InnerProps & OutterProps;

const App: FunctionComponent<Props> = ({ showRegisterAccountModal }) => {
  useEffect(() => {
    showRegisterAccountModal();
  }, [showRegisterAccountModal]);
  return (
    <>
      <AccountModal.Register />
      <Beta.Banner />
      <Layout.Background>
              ...
              <ul className="mb-0 text-primary text-justify">
                ...
                <li className="mt-4">
                  <span className="text-white">
                    ...
                    allowing you to play your ranked games against players of
                    your own skill level and at your leisure.
                  </span>
                </li>
              </ul>
            </Col>
...
const mapDispatchToProps: MapDispatchToProps<DispatchProps, OwnProps> = (
  ...
  showRegisterAccountModal: () => {
    if (!isRegisterVisited(ownProps.cookies)) {
      setTimeout(() => {
        dispatch(show(REGISTER_ACCOUNT_MODAL));
      }, 7500);
    }
  }
});
