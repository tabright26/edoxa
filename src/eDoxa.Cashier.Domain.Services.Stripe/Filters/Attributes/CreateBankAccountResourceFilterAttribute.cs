// Filename: CreateBankAccountResourceFilterAttribute.cs
...
{
    public sealed class CreateBankAccountResourceFilterAttribute : Attribute, IResourceFilter
    {
        public void OnResourceExecuting([NotNull] ResourceExecutingContext context)
        {
            ...
            {
                context.Result = new BadRequestObjectResult("A bank account is already associated with this account.");
            }
        }
