...
{
    public sealed class ChallengeStartedAt : TypeObject<ChallengeStartedAt, DateTime>
    {
        public ChallengeStartedAt(DateTime value) : base(value)
        {
        }

        public ChallengeStartedAt() : base(DateTime.UtcNow)
        {
        }
