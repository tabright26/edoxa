...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity(
                ...
                b =>
                {
                    ...
                    b.Property<decimal>("TotalScore").HasColumnType("decimal(38, 20)");

                    b.HasKey("Id");

                    b.HasIndex("GameReference").IsUnique().HasFilter("[GameReference] IS NOT NULL");
                ...
                b =>
                {
                    b.OwnsMany(
                        ...
                        b1 =>
                        {
                            ...
                            b1.Property<decimal>("PrizeAmount").HasColumnType("decimal(11, 2)");
                    ...
                    b.OwnsOne(
                        "eDoxa.Arena.Challenges.Infrastructure.Models.ChallengeSetupModel",
                        "Setup",
                        b1 =>
                        {
                            ...
                            b1.Property<decimal>("EntryFeeAmount").HasColumnType("decimal(11, 2)");
                    ...
                    b.OwnsOne(
                        "eDoxa.Arena.Challenges.Infrastructure.Models.ChallengeTimelineModel",
                        "Timeline",
                        b1 =>
                        {
                            b1.Property<Guid>("ChallengeModelId");
