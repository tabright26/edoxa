...
namespace eDoxa.Cashier.Infrastructure.Repositories
{
    ...
    public sealed partial class AccountRepository : IAccountRepository
    {
        ...
        {
            accountModel.Transactions.ForEach(
                transactionModel => this.CopyChanges(account.Transactions.Single(transaction => transaction.Id == transactionModel.Id), transactionModel)
            );
