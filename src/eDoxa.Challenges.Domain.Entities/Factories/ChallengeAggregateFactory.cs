...
namespace eDoxa.Challenges.Domain.Entities.Factories
{
    public sealed partial class ChallengeAggregateFactory : AggregateFactory
    {
    ...
    public sealed partial class ChallengeAggregateFactory
    {
