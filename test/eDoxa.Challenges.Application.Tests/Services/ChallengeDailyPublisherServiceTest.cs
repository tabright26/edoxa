// Filename: ChallengeDailyPublisherServiceTest.cs
...
{
    [TestClass]
    public sealed class ChallengeDailyPublisherServiceTest
    {
        private Mock<IChallengeRepository> _mockChallengeRepository;
        private Mock<ILogger<ChallengeDailyPublisherService>> _mockLogger;

        public ChallengeDailyPublisherServiceTest()
        {
            _mockChallengeRepository = new Mock<IChallengeRepository>();
            _mockLogger = new Mock<ILogger<ChallengeDailyPublisherService>>();
        ...
        public async Task PublishAsync_Create_ShouldBeInvoked()
        {
            ...
            var service = new ChallengeDailyPublisherService(_mockLogger.Object, _mockChallengeRepository.Object);
