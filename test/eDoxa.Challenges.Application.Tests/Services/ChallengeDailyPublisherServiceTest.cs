...
namespace eDoxa.Challenges.Application.Tests.Services
{
    ...
    public sealed class ChallengeDailyPublisherServiceTest
    {
        ...
        {
            // Arrange
            var mockLogger = new Mock<ILogger<ChallengeDailyPublisherService>>();
            ...
            // Act
            var service = new ChallengeDailyPublisherService(mockLogger.Object, mockChallengeRepository.Object);
