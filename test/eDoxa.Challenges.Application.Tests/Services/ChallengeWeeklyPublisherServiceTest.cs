...
namespace eDoxa.Challenges.Application.Tests.Services
{
    ...
    public sealed class ChallengeWeeklyPublisherServiceTest
    {
        ...
        {
            // Arrange
            var mockLogger = new Mock<ILogger<ChallengeWeeklyPublisherService>>();
            ...
            var service = new ChallengeWeeklyPublisherService(mockLogger.Object, mockChallengeRepository.Object);
