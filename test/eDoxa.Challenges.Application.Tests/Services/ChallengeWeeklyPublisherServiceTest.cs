// Filename: ChallengeWeeklyPublisherServiceTest.cs
...
{
    [TestClass]
    public sealed class ChallengeWeeklyPublisherServiceTest
    {
        private Mock<IChallengeRepository> _mockChallengeRepository;
        private Mock<ILogger<ChallengeWeeklyPublisherService>> _mockLogger;

        public ChallengeWeeklyPublisherServiceTest()
        {
            _mockChallengeRepository = new Mock<IChallengeRepository>();
            _mockLogger = new Mock<ILogger<ChallengeWeeklyPublisherService>>();
        ...
        public async Task PublishAsync_Create_ShouldBeInvoked()
        {
            ...
            var service = new ChallengeWeeklyPublisherService(_mockLogger.Object, _mockChallengeRepository.Object);
