...
{
    public sealed class WithdrawalProcessedIntegrationEventHandlerTest : IClassFixture<CashierWebApiFactory>
    {
        public WithdrawalProcessedIntegrationEventHandlerTest(CashierWebApiFactory cashierWebApiFactory)
        {
