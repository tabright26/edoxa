...
namespace eDoxa.Cashier.Application.Tests.Commands.Handlers
{
    ...
    public sealed class DeleteCardCommandHandlerTest
    {
        ...
        {
            ConstructorTests<DeleteCardCommandHandler>.For(typeof(ICashierHttpContext), typeof(IStripeService)).WithName("DeleteCardCommandHandler").Assert();
        }
        ...
        public async Task HandleAsync_DeleteCardCommand_ShouldBeOfTypeEither()
        {
            ...
            var handler = new DeleteCardCommandHandler(_mockCashierHttpContext.Object, _mockStripeService.Object);
