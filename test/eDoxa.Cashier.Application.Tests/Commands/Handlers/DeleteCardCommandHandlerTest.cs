...
namespace eDoxa.Cashier.Application.Tests.Commands.Handlers
{
    ...
    public sealed class DeleteCardCommandHandlerTest
    {
        ...
        {
            ConstructorTests<DeleteCardCommandHandler>.For(typeof(IHttpContextAccessor), typeof(IStripeService), typeof(IUserRepository)).WithName("DeleteCardCommandHandler").Assert();
        }
