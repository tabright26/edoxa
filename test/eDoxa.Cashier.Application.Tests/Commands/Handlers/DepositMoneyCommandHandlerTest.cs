...
namespace eDoxa.Cashier.Application.Tests.Commands.Handlers
{
    ...
    public sealed class DepositMoneyCommandHandlerTest
    {
        ...
        {
            ConstructorTests<DepositMoneyCommandHandler>.For(typeof(ICashierHttpContext), typeof(IMoneyAccountService), typeof(IUserRepository))
        ...
        public async Task HandleAsync_DepositMoneyCommand_ShouldBeOfTypeEither()
        {
            ...
            var handler = new DepositMoneyCommandHandler(_mockCashierHttpContext.Object, _mockMoneyAccountService.Object, _mockUserRepository.Object);
