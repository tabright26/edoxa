...
namespace eDoxa.Cashier.Application.Tests.Commands.Handlers
{
    ...
    public sealed class UpdateCardDefaultCommandHandlerTest
    {
        ...
        {
            ConstructorTests<UpdateCardDefaultCommandHandler>.For(typeof(ICashierHttpContext), typeof(IStripeService), typeof(IUserRepository))
        ...
        public async Task HandleAsync_UpdateCardDefaultCommand_ShouldBeOfTypeEither()
        {
            ...
            var handler = new UpdateCardDefaultCommandHandler(_mockCashierHttpContext.Object, _mockStripeService.Object, _mockUserRepository.Object);
