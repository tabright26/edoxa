// Filename: CreateClanAsyncTest.cs
...
{
    public sealed class CreateClanAsyncTest : IntegrationTest
    {
        public CreateClanAsyncTest(TestHostFixture testHost, TestMapperFixture testMapper) : base(testHost, testMapper)
        {
        }
