// Filename: FetchClansAsyncTest.cs
...
{
    public sealed class FetchClansAsyncTest : IntegrationTest
    {
        public FetchClansAsyncTest(TestHostFixture testHost, TestMapperFixture testMapper) : base(testHost, testMapper)
        {
        }
