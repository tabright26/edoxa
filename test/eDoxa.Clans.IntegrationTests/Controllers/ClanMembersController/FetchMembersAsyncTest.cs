// Filename: FetchMembersAsyncTest.cs
...
{
    public sealed class FetchMembersAsyncTest : IntegrationTest
    {
        public FetchMembersAsyncTest(TestHostFixture testHost, TestMapperFixture testMapper) : base(testHost, testMapper)
        {
        }
