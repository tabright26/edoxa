// Filename: KickMemberFromClanAsyncTest.cs
...
{
    public sealed class KickMemberFromClanAsyncTest : IntegrationTest
    {
        public KickMemberFromClanAsyncTest(TestHostFixture testHost, TestMapperFixture testMapper) : base(testHost, testMapper)
        {
        }
