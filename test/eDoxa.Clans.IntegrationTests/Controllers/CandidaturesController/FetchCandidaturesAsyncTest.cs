// Filename: FetchCandidaturesAsyncTest.cs
...
{
    public sealed class FetchCandidaturesAsyncTest : IntegrationTest
    {
        public FetchCandidaturesAsyncTest(TestHostFixture testHost, TestMapperFixture testMapper) : base(testHost, testMapper)
        {
        }
