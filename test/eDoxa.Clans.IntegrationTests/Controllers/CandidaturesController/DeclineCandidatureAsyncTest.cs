// Filename: DeclineCandidatureAsyncTest.cs
...
{
    public sealed class DeclineCandidatureAsyncTest : IntegrationTest
    {
        public DeclineCandidatureAsyncTest(TestHostFixture testHost, TestMapperFixture testMapper) : base(testHost, testMapper)
        {
        }
