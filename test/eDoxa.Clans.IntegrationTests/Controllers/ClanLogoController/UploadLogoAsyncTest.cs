// Filename: UploadLogoAsyncTest.cs
...
{
    public sealed class UploadLogoAsyncTest : IntegrationTest
    {
        public UploadLogoAsyncTest(TestHostFixture testHost, TestMapperFixture testMapper) : base(testHost, testMapper)
        {
        }
