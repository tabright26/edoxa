// Filename: DeleteDivisionAsyncTest.cs
...
{
    public sealed class DeleteDivisionAsyncTest : IntegrationTest
    {
        public DeleteDivisionAsyncTest(TestHostFixture testHost, TestMapperFixture testMapper) : base(testHost, testMapper)
        {
        }
        ...
        public async Task ShouldBeHttpStatusCodeNotFound()
        {
            ...
            // Act
            using var response = await this.ExecuteAsync(clan.Id, new DivisionId());
