// Filename: UpdateDivisionAsyncTest.cs
...
{
    public sealed class UpdateDivisionAsyncTest : IntegrationTest
    {
        public UpdateDivisionAsyncTest(TestHostFixture testHost, TestMapperFixture testMapper) : base(testHost, testMapper)
        {
        }
