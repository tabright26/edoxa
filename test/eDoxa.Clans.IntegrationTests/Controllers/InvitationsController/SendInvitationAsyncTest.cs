// Filename: SendInvitationAsyncTest.cs
...
{
    public sealed class SendInvitationAsyncTest : IntegrationTest
    {
        public SendInvitationAsyncTest(TestHostFixture testHost, TestMapperFixture testMapper) : base(testHost, testMapper)
        {
        }
