// Filename: DeclineInvitationAsyncTest.cs
...
{
    public sealed class DeclineInvitationAsyncTest : IntegrationTest
    {
        public DeclineInvitationAsyncTest(TestHostFixture testHost, TestMapperFixture testMapper) : base(testHost, testMapper)
        {
        }
