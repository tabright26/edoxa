// Filename: FetchInvitationsAsyncTest.cs
...
{
    public sealed class FetchInvitationsAsyncTest : IntegrationTest
    {
        public FetchInvitationsAsyncTest(TestHostFixture testHost, TestMapperFixture testMapper) : base(testHost, testMapper)
        {
        }
