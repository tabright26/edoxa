// Filename: FindInvitationAsyncTest.cs
...
{
    public sealed class FindInvitationAsyncTest : IntegrationTest
    {
        public FindInvitationAsyncTest(TestHostFixture testHost, TestMapperFixture testMapper) : base(testHost, testMapper)
        {
        }
