// Filename: FetchBankAccountAsyncTest.cs
...
{
    public sealed class FetchBankAccountAsyncTest : IntegrationTest
    {
        public FetchBankAccountAsyncTest(TestHostFixture testHost, TestMapperFixture testMapper) : base(testHost, testMapper)
        {
        }
