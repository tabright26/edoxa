...
{
    public sealed class PaymentMethodsControllerPostAsyncTest : IntegrationTest // GABRIEL: INTEGRATION TEST
    {
        public PaymentMethodsControllerPostAsyncTest(TestApiFixture testApi, TestMapperFixture testMapper) : base(testApi, testMapper)
        {
        }

        private HttpClient _httpClient;

        private async Task<HttpResponseMessage> ExecuteAsync(string paymentMethodId, PaymentMethodPutRequest request)
        {
        ...
        public async Task ShouldBeHttpStatusCodeOk()
        {
            ...
            // Act
            using var response = await this.ExecuteAsync("paymentMethodId",new PaymentMethodPutRequest(11,22));
