...
{
    public sealed class ChallengeParticipantsControllerGetAsyncTest : IClassFixture<ArenaChallengeApiFactory>
    {
        public ChallengeParticipantsControllerGetAsyncTest(ArenaChallengeApiFactory arenaChallengeApiFactory)
        {
