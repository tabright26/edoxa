...
namespace eDoxa.Challenges.UnitTests.Areas.Challenges.Services
{
    public sealed class ChallengeServiceTest : UnitTest
    {
        ...
        public async Task CreateChallengeAsync_ShouldBeOfTypeValidationResult()
        {
            ...
            mockGamesHttpClient.Setup(client => client.GetChallengeScoringAsync(It.IsAny<Game>()))
                .ReturnsAsync(new ScoringDto(scoreDictionnary))
                .Verifiable();

            mockChallengeRepository.Setup(challengeRepository => challengeRepository.Create(It.IsAny<Challenge>()))
                .Verifiable();
            ...
            var result = await challengeService.CreateChallengeAsync(
                ...
                new BestOf(5),
                new Entries(10),
                new ChallengeDuration(new TimeSpan(1,0,0,0)),
        ...
        public async Task RegisterParticipantAsync_WhenAlreadyRegistered_ShouldBeOfTypeValidationResultWithErrors()
        {
            ...
            challenge.Register(new Participant(new ParticipantId(), userId, PlayerId.Parse(Guid.NewGuid().ToString()), new UtcNowDateTimeProvider()));
        ...
        public async Task SynchronizeChallengesAsync_ShouldBeOfTypeValidationResult()
        {
            ...
            mockGamesHttpClient.Setup(client => client.GetChallengeMatchesAsync(It.IsAny<Game>(), It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>()))
            ...
            mockChallengeRepository.Verify(challengeRepository => challengeRepository.FetchChallengesAsync(It.IsAny<Game>(), It.IsAny<ChallengeState>()), Times.Once());
            mockChallengeRepository.Verify(challengeRepository => challengeRepository.CommitAsync(It.IsAny<CancellationToken>()), Times.Exactly(commitCount));
        }
        ...
        public async Task SynchronizeChallengesAsync_WhenParticipantMatchError_ShouldLogError()
        {
            ...
            mockChallengeRepository.Verify(challengeRepository => challengeRepository.FetchChallengesAsync(It.IsAny<Game>(), It.IsAny<ChallengeState>()), Times.Once());
            mockChallengeRepository.Verify(challengeRepository => challengeRepository.CommitAsync(It.IsAny<CancellationToken>()), Times.Exactly(challenges.Count));
        ...
        public async Task DeleteChallengeAsync()
        {
            ...
            mockChallengeRepository.Setup(challengeRepository => challengeRepository.Delete(It.IsAny<Challenge>()))
                .Verifiable();
