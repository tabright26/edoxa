...
namespace eDoxa.Challenges.IntegrationTests.Controllers
{
    ...
    {
        public ChallengesControllerGetByIdAsyncTest(TestApiFixture testApi, TestDataFixture testData, TestMapperFixture testMapper) : base(
            testApi,
            testData,
            testMapper)
        {
        ...
        public async Task ShouldBeHttpStatusCodeOK()
        {
            ...
            var challengeResponse = await response.Content.ReadAsAsync<ChallengeResponse>();
