// Filename: FindMatchAsyncTest.cs
...
namespace eDoxa.Challenges.IntegrationTests.Controllers.MatchesController
{
    public sealed class FindMatchAsyncTest : IntegrationTest
    {
        public FindMatchAsyncTest(TestHostFixture testHost, TestDataFixture testData, TestMapperFixture testMapper) : base(testHost, testData, testMapper)
        {
        }
