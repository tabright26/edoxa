...
namespace eDoxa.Arena.Challenges.UnitTests.Helpers.Extensions
{
    public static class FluentAssertionsExtensions
    {
        ...
        {
            challenges.ForEach(AssertStateIsValid);
        }
        ...
        {
            challenges.ForEach(AssertMappingIsValid);
        }
        ...
        {
            participants.ForEach(AssertMappingIsValid);
        }
        ...
        {
            matches.ForEach(AssertMappingIsValid);
        }
        ...
        {
            stats.ForEach(AssertMappingIsValid);
        }
