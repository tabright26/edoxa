...
{
    public sealed class InvitationsControllerGetByIdAsyncTest : IClassFixture<TestApiFixture>
    {
        private readonly TestApiFixture _apiFixture;

        public InvitationsControllerGetByIdAsyncTest(TestApiFixture apiFixture)
        {
