...
{
    public sealed class ClanMembersControllerDeleteAsyncTest : IClassFixture<TestApiFixture>
    {
        private readonly TestApiFixture _apiFixture;

        public ClanMembersControllerDeleteAsyncTest(TestApiFixture apiFixture)
        {
