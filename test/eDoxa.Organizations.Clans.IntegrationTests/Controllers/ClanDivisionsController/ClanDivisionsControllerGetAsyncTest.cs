...
namespace eDoxa.Organizations.Clans.IntegrationTests.Controllers.ClanDivisionsController
{
    ...
    {
        public ClanDivisionsControllerGetAsyncTest(TestApiFixture testApi, TestMapperFixture testMapper) : base(testApi, testMapper)
        {
        }
        ...
        public async Task ShouldBeHttpStatusCodeOk()
        {
            ...
            var challengeResponses = await response.DeserializeAsync<DivisionResponse[]>();
