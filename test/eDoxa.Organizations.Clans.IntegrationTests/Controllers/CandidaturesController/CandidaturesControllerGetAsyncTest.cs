...
{
    public sealed class CandidaturesControllerGetAsyncTest : IClassFixture<TestApiFixture>
    {
        private readonly TestApiFixture _apiFixture;
        public CandidaturesControllerGetAsyncTest(TestApiFixture apiFixture)
        {
