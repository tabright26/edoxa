// Filename: BankAccountFakerTest.cs
...
{
    [TestClass]
    public sealed class BankAccountFakerTest
    {
        [TestMethod]
        public void FakeBankAccount_ShouldNotThrow()
        {
            // Arrange
            ...
            var action = new Action(
                () =>
                {
                    ...
                    Console.WriteLine(bankAccount.DumbAsJson());
                }
            );
