// Filename: RemoveAddressAsyncTest.cs
...
{
    public sealed class RemoveAddressAsyncTest : IntegrationTest
    {
        public RemoveAddressAsyncTest(TestHostFixture testHost, TestDataFixture testData, TestMapperFixture testMapper) : base(testHost, testData, testMapper)
        {
        }
