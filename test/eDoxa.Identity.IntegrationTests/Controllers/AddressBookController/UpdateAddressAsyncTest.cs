// Filename: UpdateAddressAsyncTest.cs
...
{
    public sealed class UpdateAddressAsyncTest : IntegrationTest
    {
        public UpdateAddressAsyncTest(TestHostFixture testHost, TestDataFixture testData, TestMapperFixture testMapper) : base(testHost, testData, testMapper)
        {
        }
