// Filename: ChangeDoxatagAsyncTest.cs
...
namespace eDoxa.Identity.IntegrationTests.Controllers.DoxatagHistoryController
{
    public sealed class ChangeDoxatagAsyncTest : IntegrationTest
    {
        public ChangeDoxatagAsyncTest(TestHostFixture testHost, TestDataFixture testData, TestMapperFixture testMapper) : base(testHost, testData, testMapper)
        {
        }
