// Filename: FetchDoxatagHistoryAsyncTest.cs
...
{
    public sealed class FetchDoxatagHistoryAsyncTest : IntegrationTest
    {
        public FetchDoxatagHistoryAsyncTest(TestHostFixture testHost, TestDataFixture testData, TestMapperFixture testMapper) : base(
            testHost,
            testData,
            testMapper)
        {
