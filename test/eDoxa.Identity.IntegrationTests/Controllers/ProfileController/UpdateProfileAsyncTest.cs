// Filename: UpdateProfileAsyncTest.cs
...
{
    public sealed class UpdateProfileAsyncTest : IntegrationTest
    {
        public UpdateProfileAsyncTest(TestHostFixture testHost, TestDataFixture testData, TestMapperFixture testMapper) : base(testHost, testData, testMapper)
        {
        }
