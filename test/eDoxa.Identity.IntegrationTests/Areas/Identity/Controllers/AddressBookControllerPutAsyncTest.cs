...
{
    public sealed class AddressBookControllerPutAsyncTest : IClassFixture<IdentityWebApplicationFactory>
    {
        public AddressBookControllerPutAsyncTest(IdentityWebApplicationFactory identityWebApplicationFactory)
        {
