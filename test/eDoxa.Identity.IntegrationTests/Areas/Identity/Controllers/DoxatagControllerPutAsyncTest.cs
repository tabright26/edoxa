...
{
    public sealed class DoxaTagControllerPutAsyncTest : IClassFixture<IdentityWebApiFactory>
    {
        public DoxaTagControllerPutAsyncTest(IdentityWebApiFactory identityWebApiFactory)
        {
