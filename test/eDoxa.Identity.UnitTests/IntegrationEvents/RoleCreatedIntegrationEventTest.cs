...
{
    public sealed class RoleCreatedIntegrationEventTest : UnitTest
    {
        public RoleCreatedIntegrationEventTest(TestDataFixture testData, TestMapperFixture testMapper) : base(testData, testMapper)
        {
        }
