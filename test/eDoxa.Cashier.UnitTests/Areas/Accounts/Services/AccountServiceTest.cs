...
namespace eDoxa.Cashier.UnitTests.Areas.Accounts.Services
{
    public sealed class AccountServiceTest : UnitTest
    {
        ...
        public async Task CreateMoneyTransactionAsync_WithTypeCharge_ShouldBeOfTypeValidationResult()
        {
            ...
            // Act
            var result = await service.CreateTransactionAsync(moneyAccount, Money.Twenty, new TransactionId(), TransactionType.Charge);
        ...
        public async Task CreateMoneyTransactionAsync_WithTypeChargeWithEmptyFunds_ShouldBeOfTypeValidationResultWithErrors()
        {
            ...
            // Act
            var result = await service.CreateTransactionAsync(moneyAccount, Money.OneHundred, new TransactionId(), TransactionType.Charge);
        ...
        public async Task CreateTokenTransactionAsync_WithTypeCharge_ShouldBeOfTypeValidationResult()
        {
            ...
            // Act
            var result = await service.CreateTransactionAsync(tokenAccount, Token.FiftyThousand, new TransactionId(), TransactionType.Charge);
        ...
        public async Task CreateTransactionAsync_WithCurrencyMoney_ShouldBeOfTypeValidationResult()
        {
            ...
            // Act
            var result = await service.CreateTransactionAsync(account, 20, Currency.Money, new TransactionId(), TransactionType.Deposit);
        ...
        public async Task CreateTransactionAsync_WithCurrencyToken_ShouldBeOfTypeValidationResult()
        {
            ...
            // Act
            var result = await service.CreateTransactionAsync(account, 20, Currency.Token, new TransactionId(), TransactionType.Deposit);
        ...
        public async Task CreateTransactionAsync_WithCurrencyAll_ShouldBeOfTypeValidationResultWithErrors()
        {
            ...
            // Act
            var result = await service.CreateTransactionAsync(account, 20, Currency.All, new TransactionId(), TransactionType.Deposit);
        ...
        public async Task CreateTransactionAsync_WithWrongAmount_ShouldBeOfTypeValidationResultWithErrors()
        {
            ...
            // Act
            var result = await service.CreateTransactionAsync(account, 0, Currency.All, new TransactionId(), TransactionType.Deposit);
        ...
        public async Task FindUserAccountAsync_ShouldBeOfTypeValidationResult()
        {
            ...
            mockAccountRepository.Setup(accountRepository => accountRepository.FindUserAccountAsync(It.IsAny<UserId>()))
        ...
        public async Task CreateAccountAsync_ShouldBeOfTypeValidationResult()
        {
            ...
            mockAccountRepository.Setup(accountRepository => accountRepository.Create(It.IsAny<Account>()))
                .Verifiable();
        ...
        public async Task DepositAsync_WithCurrencyMoney_ShouldBeOfTypeValidationResult()
        {
            ...
            mockBundlesService.Setup(bundleService => bundleService.FetchDepositMoneyBundles())
                .Returns(bundle.ToImmutableHashSet())
                .Verifiable();
        ...
        public async Task DepositAsync_WithCurrencyToken_ShouldBeOfTypeValidationResult()
        {
            ...
            mockBundlesService.Setup(bundleService => bundleService.FetchDepositTokenBundles())
                .Returns(bundle.ToImmutableHashSet())
                .Verifiable();
