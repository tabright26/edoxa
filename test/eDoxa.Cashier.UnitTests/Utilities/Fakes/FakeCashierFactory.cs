...
namespace eDoxa.Cashier.UnitTests.Utilities.Fakes
{
    public sealed class FakeCashierFactory
    {
        ...
        public User CreateUser()
        {
            return new User(
                this.CreateUserId(),
                new StripeConnectAccountId("acct_qweqwe1231qwe").ToString(),
                new StripeCustomerId("cus_qweqwe1231qwe").ToString()
            );
        }
