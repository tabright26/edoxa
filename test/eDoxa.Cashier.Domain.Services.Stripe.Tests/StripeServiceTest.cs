...
namespace eDoxa.Cashier.Domain.Services.Stripe.Tests
{
    ...
    public sealed class StripeServiceTest
    {
        ...
        private Mock<PayoutService> _mockPayoutService;
        ...
        {
            // Arrange
            _mockBankAccountService.Setup(mock => mock.CreateAsync(It.IsAny<string>(), It.IsAny<BankAccountCreateOptions>(), It.IsAny<RequestOptions>(), It.IsAny<CancellationToken>()))
            ...
            // Assert
            _mockBankAccountService.Verify(mock => mock.CreateAsync(It.IsAny<string>(), It.IsAny<BankAccountCreateOptions>(), It.IsAny<RequestOptions>(), It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        {
            // Arrange
            _mockCardService.Setup(mock => mock.CreateAsync(It.IsAny<string>(), It.IsAny<CardCreateOptions>(), It.IsAny<RequestOptions>(), It.IsAny<CancellationToken>()))
            ...
            // Assert
            _mockCardService.Verify(mock => mock.CreateAsync(It.IsAny<string>(), It.IsAny<CardCreateOptions>(), It.IsAny<RequestOptions>(), It.IsAny<CancellationToken>()), Times.Once);
        ...
        public async Task DeleteCardAsync()
        {
            ...
            // Assert
            _mockCardService.Verify(mock => mock.DeleteAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<RequestOptions>(), It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        public async Task CreateInvoiceAsync()
        {
            ...
            _mockInvoiceItemService.Setup(mock => mock.CreateAsync(It.IsAny<InvoiceItemCreateOptions>(), It.IsAny<RequestOptions>(), It.IsAny<CancellationToken>()))
            ...
            _mockInvoiceItemService.Verify(mock => mock.CreateAsync(It.IsAny<InvoiceItemCreateOptions>(), It.IsAny<RequestOptions>(), It.IsAny<CancellationToken>()), Times.Once);

            _mockInvoiceService.Verify(mock => mock.CreateAsync(It.IsAny<InvoiceCreateOptions>(), It.IsAny<RequestOptions>(), It.IsAny<CancellationToken>()), Times.Once);
        }
